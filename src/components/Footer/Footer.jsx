    ...
    <footer className="fixed-bottom">
      <div className="row mt-3 pt-4 pb-2 bg-body-tertiary">
        <div className="col-4 text-center text-success h1">
          <Link to="/" className="text-success"> {/* BEGIN: Add route to "/" */}
        ...
        <div className="col-4 text-center text-success h1">
          <Link to="/data" className="text-success"> {/* BEGIN: Add route to "/data" */}
            <div className="text-center">
        ...
        <div className="col-4 text-center  h1">
          <Link to="/chat" className="text-success"> {/* BEGIN: Add route to "/chat" */}
            <div className="text-center">
